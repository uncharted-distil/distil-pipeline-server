...
type PipelineDescription struct {
	...
	// TODO: Deprecated. Remove.
	Context PipelineContext `protobuf:"varint,4,opt,name=context,proto3,enum=PipelineContext" json:"context,omitempty"` // Deprecated: Do not use.
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	...
	,
}
